...
keys_cts = {'Quito_Belisario':'Q_BE',
        'Rio_PedraDeGuaratiba': 'R_PG',
        'Quito_El_Camal': 'Q_EC',
        'Quito_Carapungo': 'Q_CA',
        'Quito_Centro': 'Q_CE',
        'Quito_Cotocollao': 'Q_CO',
        'Quito_Guamani': 'Q_GU',
        'Quito_Tumbaco': 'Q_TU',
        'Quito_LosChillos': 'Q_LC',
        'Rio_Copacabana': 'R_CC',
        'Rio_Tijuca': 'R_TI',
        'Rio_Centro': 'R_CE',
        'Rio_SaoCristovao':'R_SC',
        'Rio_Bangu':'R_BG',
        'Rio_CampoGrande':'R_CG',
        'Rio_Iraja': 'R_IR',
        'DoS_AbuDhabi':'D_AD',
        'DoS_AddisAbabaCentral':'ADDC',
        'DoS_AddisAbabaSchool':'ADDS',
        'DoS_Beijing':'D_BE',
        'DoS_Bogota':'D_BO',
        'DoS_Chengdu':'D_CD',
        'DoS_Chennai':'D_CH',
        ...
        'DoS_HoChiMinh':'D_HO',
        'DoS_Hyderabad':'D_HY',
        'DoS_JakartaCentral':'D_JK',
        'DoS_JakartaSouth':'D_JS',
        'DoS_Kampala':'D_KM',
        'DoS_Kolkata':'D_KL',
        'DoS_KuwaitCity':'D_KU',
        'DoS_Lima':'LIMA',
        ...
        'DoS_Mumbai':'D_MU',
        'DoS_NewDelhi':'D_ND',
        'DoS_PhoraDurbarKathmandu':'D_PH',
        'DoS_Pristina':'DPRI',
        'DoS_Shanghai':'DSHG',
        'DoS_Shenyang':'DSHY',
        'DoS_Ulaanbaatar':'DULA',
        'WRI_Bogota_Centro_de_Alto_Rendimiento_CDAR':'BCDA',
        'WRI_Bogota_Guaymaral_GYR':'BGUA',
        'WRI_Bogota_Las_Ferias_LFR':'BLFR',
        'WRI_Bogota_Puente_Aranda_PTE':'BPTE',
        'WRI_Bogota_Tunal_TUN':'BTUN',
        'WRI_Guadalajara_Oblatos_OBL':'BOBL',
        'WRI_Monterrey_Cadereyta_MXMTYSE3':'MXMC',
        'WRI_Monterrey_Obispado_MXMTYCE':'MXMO',
        'WRI_Sao_Paulo_Cerqueira_Cesar_CER':'SCER',
        'WRI_Sao_Paulo_Congonhas_CON':'SCON',
        'WRI_Sao_Paulo_Ibirapuera_IBI':'SIBI',
        'WRI_Sao_Paulo_Interlagos_INT':'SINT',
        'WRI_Sao_Paulo_Itaim_Paulista_ITA':'SITA',
        'WRI_Sao_Paulo_Marg_Tiete__Ponte_dos_Remedios_MAR':'SMAR',
        'WRI_Sao_Paulo_Mooca_MOO':'SMOO',
        'WRI_Sao_Paulo_Osasco_OSA':'',
        'WRI_Sao_Paulo_Parque_D_Pedro_II_PAR':'SPAR',
        'WRI_Sao_Paulo_Pico_do_Jaragua_PIC':'SPIC',
        'WRI_Sao_Paulo_Pinheiros_PIN':'SPIN',
        'WRI_Sao_Paulo_Santana_SAN':'SSAN',
        'WRI_Bogota_MinAmbiente_MAM':'BMAM',
        'WRI_Bogota_Usaquan_USQ':'BUSQ',
        'WRI_Monterrey_La_Pastora_MXMTYSE1':'MXMP',
        'WRI_Sao_Paulo_Cid_Universitaria__USP__IPEN_CUU':'SCUU',
        'WRI_Sao_Paulo_Grajau__Parelheiros_GRA':'SGRA'}
...
# the main (init+loop)
def main():
    pygame.display.set_caption(' . A i R E . W 2 0 + .')
    init_osc()
    load_data()
    load_data_cts()
    if (onTrain):
