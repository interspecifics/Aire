...
miniconda windows: https://docs.conda.io/projects/conda/en/latest/user-guide/install/windows.html
miniconda mac: https://docs.conda.io/projects/conda/en/latest/user-guide/install/macos.html
